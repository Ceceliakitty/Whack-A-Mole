...
//     malletCursor.src = 'assets/mallet.png';

//     // Set the cursor to none (hide the default cursor)
...
//       malletCursor.style.position = 'absolute';
//       malletCursor.style.left = (event.clientX - malletCursor.width / 2) + 'px';
